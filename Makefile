...
DISTDIR = /home/by/Masaüstü/e-tahta-debian/.tmp/e-tahta1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
moc_mainwindow.cpp: mainwindow.h \
		...
		moc_predefs.h \
		/usr/lib/qt5/bin/moc
	/usr/lib/qt5/bin/moc $(DEFINES) --include /home/by/Masaüstü/e-tahta-debian/moc_predefs.h -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++ -I/home/by/Masaüstü/e-tahta-debian -I/usr/include/opencv4 -I/usr/include/poppler/qt5 -I/usr/include/x86_64-linux-gnu/qt5 -I/usr/include/x86_64-linux-gnu/qt5/QtPrintSupport -I/usr/include/x86_64-linux-gnu/qt5/QtWidgets -I/usr/include/x86_64-linux-gnu/qt5/QtGui -I/usr/include/x86_64-linux-gnu/qt5/QtXml -I/usr/include/x86_64-linux-gnu/qt5/QtNetwork -I/usr/include/x86_64-linux-gnu/qt5/QtCore -I/usr/include/c++/12 -I/usr/include/x86_64-linux-gnu/c++/12 -I/usr/include/c++/12/backward -I/usr/lib/gcc/x86_64-linux-gnu/12/include -I/usr/local/include -I/usr/include/x86_64-linux-gnu -I/usr/include mainwindow.h -o moc_mainwindow.cpp
...
install_desktop_file: first FORCE
	...
	$(QINSTALL) /home/by/Masaüstü/e-tahta-debian/e-tahta.desktop $(INSTALL_ROOT)/usr/share/applications/e-tahta.desktop
...
install_icon: first FORCE
	...
	$(QINSTALL) /home/by/Masaüstü/e-tahta-debian/icons/e-tahta.png $(INSTALL_ROOT)/usr/share/e-tahta/e-tahta.png
...
install_config_file: first FORCE
	...
	$(QINSTALL) /home/by/Masaüstü/e-tahta-debian/e-tahta.ini $(INSTALL_ROOT)/usr/share/e-tahta/e-tahta.ini/e-tahta.ini
...
install_auto_start: first FORCE
	...
	$(QINSTALL_PROGRAM) /home/by/Masaüstü/e-tahta-debian/e-tahta-autostart.desktop $(INSTALL_ROOT)/etc/xdg/autostart/e-tahta-autostart.desktop
...
install_desktopfile: first FORCE
	@test -d $(INSTALL_ROOT)/usr/bin/ || mkdir -p $(INSTALL_ROOT)/usr/bin/
	$(QINSTALL_PROGRAM) /home/by/Masaüstü/e-tahta-debian/e-tahtaxdglink.sh $(INSTALL_ROOT)/usr/bin/e-tahtaxdglink.sh
