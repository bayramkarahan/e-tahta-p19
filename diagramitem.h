...
{
public:
     enum DiagramType {NoType,NDogru,NNKoordinat,NKoordinat,HNKoordinat, Kup,Pramit,Kure,Silindir,Pergel,Cetvel,Gonye,Iletki,Cizgi,Ok,CiftOk,Ucgen,Dortgen,Cember,
                       Baklava,ParalelKenar,Yamuk,Besgen,
                       Altigen,Sekizgen,DikUcgen,Resim,
                       GuzelYazi,Muzik,CizgiliSayfa,
                       KareliKagit,CizgiliKagit,NoktaliKagit,IzometrikKagit,
                       Kalem,DrawPath,DrawPoligon,Pdf,Copy};
